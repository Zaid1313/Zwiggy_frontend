        ...
        <div className="carousel-inner" id="carousel">
          <div className="carousel-caption" style={{zIndex: "10"}}>
            <form className="d-flex">
             ...
             <button className="btn btn-outline-danger text-black bg-danger" type="submit">Search</button>
            </form>
          </div>  
          ...
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900×700?curry" className="d-block w-100" style={{filter: "brightness(40%)"}} alt="..." />
          </div>
          <div className="carousel-item">
